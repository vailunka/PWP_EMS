...
from db_implementation import db, Event, User, create_database
...
def database_init(test_client):
    # Add a value to User
    user = User(name="Joni Maisema", email="joni.maisema@gmail.com", phone_number= "12345678")
    db.session.add(user)

    # Add a value to Event
    event = Event(name="Testing Event", location="Testing Location", time="2025-2-28 15:00:00", organizer=user.id,
                       description="Lorem ipsum...", category="Testing Category", tags="testing, tech")
